...
const Students = () => {
  ...
  const initialFormData = {
    ...
    address: '',
    department: '',
    year: 'Freshman', // Changed to match backend enum
    status: 'Active'
  };
  ...
  const displayStudents = Array.isArray(studentsArray) ? studentsArray : fallbackStudents;
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                value={safeFormData.year || 'Freshman'}
